  ...
  en: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        "I have a strong technical foundation and a great motivation to work with backend technologies. I have experience building backend services, RESTful APIs, and databases, and I am used to working in a structured way with version control and collaboration in teams. I also have a natural curiosity and quickly adapt to new technologies and domains.",
        ...
        "Outside of tech, my background as a store manager sharpened my communication, structure, and teamwork skills. I thrive in agile, collaborative environments where knowledge is shared and quality is a shared responsibility.",
      ],
    },
    projects: {
      title: "Projects",
  ...
  da: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        "Jeg har et stærkt teknisk fundament og en stor motivation for at arbejde med backend-teknologier. Jeg har erfaring med opbygning af backend-services, RESTful APIs og databaser, og jeg er vant til at arbejde struktureret med versionsstyring og samarbejde i teams. Jeg har desuden en naturlig nysgerrighed og sætter mig hurtigt ind i nye teknologier og domæner.",
        ...
        "Uden for tech har min baggrund som butikschef styrket mine kommunikations-, struktur- og samarbejdsevner. Jeg trives i agile, samarbejdsorienterede miljøer, hvor viden deles, og kvalitet er et fælles ansvar.",
      ],
    },
    projects: {
      title: "Projekter",
