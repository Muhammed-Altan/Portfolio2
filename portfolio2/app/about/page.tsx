  ...
  return (
    <div className="flex flex-col justify-between min-h-full">
      <section className="flex flex-col gap-5">
        <h1 className="text-4xl font-bold text-white">About Muhammed</h1>
        <h1 className="text-4xl font-bold text-zinc-400">More than a name, more than a title</h1>
        <p className="text-lg text-zinc-300 leading-relaxed">
          ...
          With my background as a multimedie designer, I have a unique perspective on user experience and design, which I integrate into my development work to create seamless and engaging applications.
